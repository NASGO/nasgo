...
var Sandbox = require('nasgo-sandbox');
var rmdir = require('rimraf');
var ip = require('ip');
var valid_url = require('valid-url');
var DecompressZip = require('decompress-zip');
var dappCategory = require('../helpers/tools/dapp-category.js');
...
function OutTransfer() {
  ...
  this.apply = function (trs, block, sender, cb) {
    ...
    if (transfer.currency !== 'NSG') {
      ...
      async.series([
        ...
        function (next) {
          library.model.updateAssetBalance('NSG', '-' + trs.fee, transfer.dappId, next)
        },
        function (next) {
      ...
      modules.accounts.setAccountAndGet({ address: trs.recipientId }, function (err, recipient) {
        ...
        modules.accounts.mergeAccountAndGet({
          ...
          library.model.updateAssetBalance('NSG', -amount - trs.fee, transfer.dappId, cb);
        });
      });
    }
  }
  ...
  this.applyUnconfirmed = function (trs, sender, cb) {
    ...
    if (transfer.currency === 'NSG') {
      ...
      var xasBalance = library.balanceCache.getAssetBalance(transfer.dappId, 'NSG') || 0
      ...
      library.balanceCache.addAssetBalance(transfer.dappId, 'NSG', -fee)
...
function InTransfer() {
  ...
  this.getBytes = function (trs) {
    try {
      ...
      if (trs.asset.inTransfer.currency !== 'NSG') {
  ...
  this.applyUnconfirmed = function (trs, sender, cb) {
    var transfer = trs.asset.inTransfer
    if (transfer.currency === 'NSG') return setImmediate(cb)
