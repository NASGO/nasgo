...
var BlockStatus = require("../helpers/tools/block-status.js");
var constants = require('../helpers/tools/constants.js');
...
Blocks.prototype.setLastBlock = function (block) {
  ...
  if (global.Config.netVersion === 'mainnet') {
    ...
    global.featureSwitch.enableClubBonus = false
  ...
  if (global.Config.netVersion === 'mainnet' && private.lastBlock.height < 1) {
