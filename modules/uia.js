...
var Router = require('../helpers/tools/router.js')
var TransactionTypes = require('../helpers/tools/transaction-types.js')
var sandboxHelper = require('../helpers/tools/sandbox.js')
var flagsHelper = require('./asset/flags-helper.js')
var addressHelper = require('../helpers/tools/address.js')
var amountHelper = require('../helpers/tools/amount.js')
...
function UIA(cb, scope) {
  ...
  library.base.transaction.attachAssetType(TransactionTypes.UIA_ISSUER, require('./asset/issuer.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_ASSET, require('./asset/asset.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_FLAGS, require('./asset/flags.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_ACL, require('./asset/acl.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_ISSUE, require('./asset/issue.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_TRANSFER, require('./asset/transfer.js'))
